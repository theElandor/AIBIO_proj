#!/bin/bash
#SBATCH -e /homes/mlugli/output/f3o.txt
#SBATCH -o /homes/mlugli/output/f3e.txt
#SBATCH --job-name=DINO_f3
...
python3 /homes/mlugli/AIBIO_proj/dino/main_dino.py \
    ...
    --metadata_path /work/h2020deciderficarra_shared/rxrx1/rxrx1_orig/metadatas/meta_3.csv \
    --output_dir /work/h2020deciderficarra_shared/rxrx1/checkpoints/dino/folds/f3 \
