#!/bin/bash
#SBATCH -e /homes/mlugli/output/f2o.txt
#SBATCH -o /homes/mlugli/output/f2e.txt
#SBATCH --job-name=DINO_f2
...
python3 /homes/mlugli/AIBIO_proj/dino/main_dino.py \
    ...
    --metadata_path /work/h2020deciderficarra_shared/rxrx1/rxrx1_orig/metadatas/meta_2.csv \
    --output_dir /work/h2020deciderficarra_shared/rxrx1/checkpoints/dino/folds/f2 \
