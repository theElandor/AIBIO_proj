#!/bin/bash
#SBATCH -e /homes/mlugli/output/f1o.txt
#SBATCH -o /homes/mlugli/output/f1e.txt
#SBATCH --job-name=DINO_f1
...
python3 /homes/mlugli/AIBIO_proj/dino/main_dino.py \
    ...
    --output_dir /work/h2020deciderficarra_shared/rxrx1/checkpoints/dino/folds/f1 \
