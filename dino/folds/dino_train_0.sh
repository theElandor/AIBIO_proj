#!/bin/bash
#SBATCH -e /homes/mlugli/output/f0o.txt
#SBATCH -o /homes/mlugli/output/f0e.txt
#SBATCH --job-name=DINO_f0
...
python3 /homes/mlugli/AIBIO_proj/dino/main_dino.py \
    ...
    --output_dir /work/h2020deciderficarra_shared/rxrx1/checkpoints/dino/folds/f0 \
