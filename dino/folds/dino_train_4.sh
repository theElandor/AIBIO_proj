#!/bin/bash
#SBATCH -e /homes/mlugli/output/f4o.txt
#SBATCH -o /homes/mlugli/output/f4e.txt
#SBATCH --job-name=DINO_f4
...
python3 /homes/mlugli/AIBIO_proj/dino/main_dino.py \
    ...
    --metadata_path /work/h2020deciderficarra_shared/rxrx1/rxrx1_orig/metadatas/meta_4.csv \
    --output_dir /work/h2020deciderficarra_shared/rxrx1/checkpoints/dino/folds/f4 \
