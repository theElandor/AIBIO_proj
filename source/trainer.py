...
class Norm_Trainer():
    ...
    """
        ...
        train_dataloader = DataLoader(train_dataset, batch_size=self.config["batch_size"], shuffle=True,
                                      num_workers=train_workers, drop_last=True, prefetch_factor=2, persistent_workers=True,collate_fn=custom_collate_fn)
        val_dataloader = DataLoader(val_dataset, batch_size=self.config["batch_size"], shuffle=True,
                                    num_workers=evaluation_workers, drop_last=True, prefetch_factor=2,collate_fn=custom_collate_fn)
